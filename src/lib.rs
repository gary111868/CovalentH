...
#[derive(Debug)]
pub struct CovalentHQProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CovalentHQProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CovalentHQ processing");
    
    let mut processor = CovalentHQProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CovalentHQProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CovalentHQProcessor::new(false);
